...
//edit house silo
Future<void> API_edit_house_silo(
    String? Token, var Farm, var House, var Silo, var Feed) async {
  try {
...
//edit house usage
Future<void> API_edit_house_usage(
    String? Token,
    var Farm,
    var House,
    var production,
...
//edit weight setting
Future<void> API_edit_weight_setting(
    String? Token,
    var Farm,
    var House,
    var poultry_weight,
...
//edit order-create
Future<void> API_edit_order_create(
    String? Token,
    var Farm,
    var order_date,
    var filling_date,
...
//edit order-edit
Future<void> API_edit_order_edit(
  String? Token,
  var Farm,
  var order_ref,
  var order_date,
...
//edit setting farm
Future<void> API_edit_setting_farm(
    String? Token,
    var Farm,
    var farm_name,
    var species,
...
Future<void> API_edit_setting_house_1(
    String? Token,
    var Farm,
    var house,
    var house_name,
...
//edit setting silo_2
Future<void> API_edit_setting_silo_2(
    String? Token,
    var Farm,
    var house,
    var silo,
  ...
  try {
    ...
    if (ressum.statusCode == 200) {
      showNot(
          'edit setting house silo', '${jsonDecode(ressum.body)['message']}');
      print('successfully');
    } else {
      showNot(
          'edit setting house silo', '${jsonDecode(ressum.body)['message']}');
...
Future<void> API_edit_setting_production(
    String? Token,
    var Farm,
    var house,
    var namecrop,
  ...
  try {
    var urlsum =
        Uri.https("smartfarmpro.com", "/v1/api/edit/setting-production");
    var ressum = await http.post(urlsum,
        headers: {
          "Authorization": "Bearer $Token",
          'Content-Type': 'application/json'
    ...
    if (ressum.statusCode == 200) {
      showNot(
          'edit setting production', '${jsonDecode(ressum.body)['message']}');
      print('successfully');
    } else {
      showNot(
          'edit setting production', '${jsonDecode(ressum.body)['message']}');
