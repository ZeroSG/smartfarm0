...
class _HouseState extends State<House> {
  ...
  Future<void> getjaon1_setting_house() async {
    try {
      loading1 = true;
      var urlsum =
          Uri.https("smartfarmpro.com", "/v1/api/setting/setting-house");
      var ressum = await http.post(urlsum,
          ...
          body: jsonEncode(
              <String, dynamic>{"Farm": widget.farmnum, "House": Houseid}));
      if (ressum.statusCode == 200) {
        ...
        setState(() {
          ...
          Minimum_Usage.text =
              nowresult1_1[0]["n_min_intake_percent"].toString();
          Maximum_Usage.text =
              nowresult1_1[0]["n_max_intake_percent"].toString();
          Minimum_Weight.text =
              nowresult1_1[0]["n_min_weight_percent"].toString();
          Maximum_Weight.text =
              nowresult1_1[0]["n_max_weight_percent"].toString();
                      ...
                      setState(() {
                        ...
                        for (int i = 0; i < nowresult1_2.length; i++) {
                          if (nowresult1_2[i]['c_name'] == Siloname) {
                            ...
                            Capacity.text =
                                nowresult1_2[i]["n_capacity"].toString();
                            Topup.text = nowresult1_2[i]["n_topup"].toString();
                            Very_Lower.text = nowresult1_2[i]
                                    ["n_verylower_percent"]
                                .toString();
                            Lower.text =
                                nowresult1_2[i]["n_lower_percent"].toString();
                            Upper_Percent.text =
                                nowresult1_2[i]["n_upper_percent"].toString();
                          }
                        }
                      });
                    }),
